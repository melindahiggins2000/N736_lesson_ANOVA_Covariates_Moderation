...
proc glm data=helpmkh;
  model indtot = cesd mcs pcs;
  run;

* change order of variables and note
  difference in Type I and Type III SS
  - especially notice p-value for pcs;

proc glm data=helpmkh;
  model indtot = pcs mcs cesd;
  run;
